(function(){
  ...
  $('#datatables2').dataTable({
    'autoWidth': false,
    'sDom': '<"row"<"col-sm-12 panel-heading panel-heading-embed"<"pull-right"f><"pull-left">r<"clearfix">>>t<"row datatable-footer-pagination"<"col-sm-12"<"datatable-pagination"p><"pull-right pagination-info"i><"clearfix">>>',
  ...
  $('.dataTable').each(function(){
    ...
    var searchInput = datatables.closest('.dataTables_wrapper').parents(".panel-table").find('div[id$=_filter] input');
