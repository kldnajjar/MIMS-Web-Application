(function(){
  ...
  lineData = {
    labels: ['Sep 01, 2015', 'Sep 10, 2015', 'Sep 15, 2015', 'Sep 20, 2015', 'Sep 25, 2015', 'Sep 30, 2015'],
    datasets: [
      {
        label: 'User#1',
        fillColor: 'transparent',
        strokeColor: 'rgba(242, 196, 0, 1)',
        pointColor: 'rgba(242, 196, 0, 1)',
        pointStrokeColor: '#ffffff',
        pointHighlightFill: '#ffffff',
        pointHighlightStroke: 'rgba(237, 85, 101, 0.8)',
        data: [0.4, 0.3, 0.5, 0.55, 0.7, 0.6, 0.95, 0.8, 0.75, 0.9]
      },
      {
        label: 'User#2',
        fillColor: 'transparent',
        ...
        data: [0.95, 0.75, 0.8, 0.7, 0.73, 0.5, 0.6, 0.49, 0.5, 0.3,0.47]
      }
    ]
  },
  ...
  // Bar #2 - #4
  /*bar2Ctx = document.getElementById('chartjs-bar2').getContext('2d'),
  ...
  var bar4Ctx = document.getElementById('chartjs-bar4').getContext('2d'),
  bar4Data = {
    labels: ['0', '100', '200'],
    datasets: [
      { label: 'Clothes', fillColor: 'rgba(237, 85, 101, 1)', highlightFill: 'rgba(237, 85, 101, 0.8)', data: [1,2,3,4] },
      { label: 'Trousers', fillColor: 'rgba(93, 156, 236, 1)', highlightFill: 'rgba(93, 156, 236, 0.8)', data: [6,5,4,3] }
    ]
  },  
  ...
  doughnutData = [
    { value: 0.75, color: '#3ebb64', highlight: '#86bc97', label: 'Handled' },
    { value: 0.25, color: '#f2c400', highlight: '#f0df97', label: 'Pending' }
  ],
